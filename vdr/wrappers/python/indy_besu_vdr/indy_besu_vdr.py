...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_assign_role_transaction() != 19303:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_credential_definition_endorsing_data() != 5243:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_resource_mapping_transaction() != 6041:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_definition_endorsing_data() != 28795:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_definition_transaction() != 44811:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_entry_endorsing_data() != 21966:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_revocation_registry_entry_transaction() != 54445:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_schema_endorsing_data() != 24765:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_create_schema_transaction() != 45770:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_resolve_did_transaction() != 30138:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_build_resolve_revocation_registry_definition_transaction() != 33250:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_resource_mapping_result() != 47018:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_parse_revocation_registry_definition() != 18824:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_did() != 45456:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_revocation_registry_definition() != 15143:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_revocation_registry_status_list() != 56776:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_revocation_registry_status_list_full() != 45673:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_resolve_schema() != 2703:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_definition_from_string() != 29305:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_definition_get_id() != 31898:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_definition_to_string() != 12418:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_entry_from_string() != 18719:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_registry_entry_to_string() != 3641:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_status_list_from_string() != 39335:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indy_besu_vdr_uniffi_checksum_func_revocation_status_list_to_string() != 48449:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_definition_endorsing_data.restype = ctypes.c_void_p
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_definition_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_definition_transaction.restype = ctypes.c_void_p
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_entry_endorsing_data.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_entry_endorsing_data.restype = ctypes.c_void_p
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_entry_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_create_revocation_registry_entry_transaction.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_build_resolve_revocation_registry_definition_transaction.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_definition.restype = ctypes.c_void_p
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_status_list.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_status_list.restype = ctypes.c_void_p
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_status_list_full.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_resolve_revocation_registry_status_list_full.restype = ctypes.c_void_p
...
def build_create_credential_definition_endorsing_data(client: "LedgerClient",credential_definition: "CredentialDefinition"):
    _UniffiConverterTypeLedgerClient.check_lower(client)
...
def build_create_revocation_registry_definition_endorsing_data(client: "LedgerClient",rev_reg_def: "RevocationRegistryDefinition"):
    _UniffiConverterTypeLedgerClient.check_lower(client)
...
def build_create_revocation_registry_definition_transaction(client: "LedgerClient",_from: "str",rev_reg_def: "RevocationRegistryDefinition"):
    _UniffiConverterTypeLedgerClient.check_lower(client)
...
def build_create_revocation_registry_entry_endorsing_data(client: "LedgerClient",rev_reg_entry: "RevocationRegistryEntry"):
    _UniffiConverterTypeLedgerClient.check_lower(client)
...
def build_create_revocation_registry_entry_transaction(client: "LedgerClient",_from: "str",rev_reg_entry: "RevocationRegistryEntry"):
    _UniffiConverterTypeLedgerClient.check_lower(client)
...
def build_create_schema_transaction(client: "LedgerClient",_from: "str",schema: "Schema"):
    _UniffiConverterTypeLedgerClient.check_lower(client)
...
def build_resolve_revocation_registry_definition_transaction(client: "LedgerClient",rev_reg_def_id: "str"):
    _UniffiConverterTypeLedgerClient.check_lower(client)
...
def parse_revocation_registry_definition(client: "LedgerClient",bytes: "bytes") -> "JsonValue":
    ...
    return _UniffiConverterTypeJsonValue.lift(_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_parse_revocation_registry_definition,
        _UniffiConverterTypeLedgerClient.lower(client),
        _UniffiConverterBytes.lower(bytes)))
...
def resolve_revocation_registry_definition(client: "LedgerClient",rev_reg_def_id: "str"):
    _UniffiConverterTypeLedgerClient.check_lower(client)
...
def resolve_revocation_registry_status_list(client: "LedgerClient",rev_reg_def_id: "str",timestamp: "int"):
    _UniffiConverterTypeLedgerClient.check_lower(client)
...
def resolve_revocation_registry_status_list_full(client: "LedgerClient",rev_reg_def_id: "str",timestamp: "int"):
    _UniffiConverterTypeLedgerClient.check_lower(client)
...
def revocation_registry_definition_from_string(rev_reg_def_str: "str") -> "RevocationRegistryDefinition":
    ...
    return _UniffiConverterTypeRevocationRegistryDefinition.lift(_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_definition_from_string,
...
def revocation_registry_definition_get_id(rev_reg_def: "RevocationRegistryDefinition") -> "str":
    ...
    return _UniffiConverterString.lift(_rust_call(_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_definition_get_id,
        _UniffiConverterTypeRevocationRegistryDefinition.lower(rev_reg_def)))
...
def revocation_registry_definition_to_string(rev_reg_def: "RevocationRegistryDefinition") -> "str":
    ...
    return _UniffiConverterString.lift(_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_definition_to_string,
        _UniffiConverterTypeRevocationRegistryDefinition.lower(rev_reg_def)))
...
def revocation_registry_entry_from_string(rev_reg_entry_str: "str") -> "RevocationRegistryEntry":
    ...
    return _UniffiConverterTypeRevocationRegistryEntry.lift(_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_entry_from_string,
...
def revocation_registry_entry_to_string(rev_reg_entry: "RevocationRegistryEntry") -> "str":
    ...
    return _UniffiConverterString.lift(_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_registry_entry_to_string,
        _UniffiConverterTypeRevocationRegistryEntry.lower(rev_reg_entry)))
...
def revocation_status_list_from_string(status_list_str: "str") -> "RevocationStatusList":
    ...
    return _UniffiConverterTypeRevocationStatusList.lift(_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_status_list_from_string,
...
def revocation_status_list_to_string(status_list: "RevocationStatusList") -> "str":
    ...
    return _UniffiConverterString.lift(_rust_call_with_error(_UniffiConverterTypeVdrError,_UniffiLib.uniffi_indy_besu_vdr_uniffi_fn_func_revocation_status_list_to_string,
